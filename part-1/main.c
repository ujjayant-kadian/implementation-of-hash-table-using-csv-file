...
#define ARRAY_SIZE 59 //best be prime 53
...
//Following array is the hash table
Element* hashTable[ARRAY_SIZE];

//Initialising the hash table if all the pointers are not null initially, as a precaution
...
//Creates a element in heap and return its pointer
...
//Creates a new element in the hash table and counts the number of collisions
...
int main(int argc, char** argv)
{
    ...
    for(;;){
        printf(">>> ");
        scanf(" %[^\n]s", answer);//To input answer with spaces too - space infront of % is imp
